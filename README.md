...
- Finish first release of opening CSV files with previous metadata scans, since scans can take time, being able to open a previous scan can help reduce the amount of time needed to search for data
